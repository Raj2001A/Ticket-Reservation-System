package com.example.Raja.myapplication.Required;
...
import com.example.Raja.myapplication.R;
...
public class Confirm extends AppCompatActivity implements View.OnClickListener {
    ...
    String train_name, class_type, no_of_tickets, name, age, mob_number, final_price, berth_type, price, train_number,
            str_avail, answer, date;
    ...
    public void onClick(View v) {
        ...
        if (v == confirm) {
            ...
            if (net) {
                ...
                displayTicket(train_number, train_name, no_of_tickets, class_type, name, age, berth_type, mob_number,
                        date);
            } else
